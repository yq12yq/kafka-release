...
public class BlockingPlaintextAuthenticator implements Authenticator {
    private final BlockingPlaintextTransportLayer transportLayer;
    private final KafkaPrincipalBuilder principalBuilder;

    public BlockingPlaintextAuthenticator(Map<String, ?> configs, BlockingPlaintextTransportLayer transportLayer) {
