...
public class SSLTransportLayer implements TransportLayer {
    ...
    public int handshake(boolean read, boolean write) throws IOException {
        ...
        case NOT_HANDSHAKING:
            ...
            if (handshakeResult.getHandshakeStatus() == HandshakeStatus.FINISHED) {
                ...
                if (handshakeComplete) return 0; else return SelectionKey.OP_WRITE;
            } else {
                //should never happen
        ...
        if (handshakeComplete) return 0; else return (SelectionKey.OP_WRITE|SelectionKey.OP_READ);
    }
    ...
    * @throws IlleagalStateException if the destination buffer is different than appBufHandler.getReadBuffer()
    */
    public int read(ByteBuffer dst) throws IOException {
        ...
        do {
            ...
            if(unwrap.getStatus() == Status.OK || unwrap.getStatus() == Status.BUFFER_UNDERFLOW) {
                ...
                // in constructor
                throw new IOException(String.format("Unable to unwrap data, invalid status [%d]",unwrap.getStatus()));
            }
